...
from models.ChangeFormer_TTTA import ChangeFormer_TTTA
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    if args.net_G == 'base_resnet18':
        ...
        if 'ttta.yaml' in args.cfg_file:
            print("you are using ChangeFormer_TTTA")
            net = ChangeFormer_TTTA(embed_dim=args.embed_dim)
        else:
