...
_C.ReCAP.MARGIN = 1.0
_C.ReCAP.MARGIN_L0 = 1.0
_C.ReCAP.WEIGHT_REG = 0.5
_C.ReCAP.REWEIGHT_THRESHOLD = 1.5

_C.ReCAP.WEIGHT_TAU = 1.2
# ------------------------------- TTTA options ----------------------------- #
_C.TTTA = CfgNode()

_C.TTTA.MARGIN = 0.4
_C.TTTA.RESET_EMA = 0.12
_C.TTTA.AP = 0.92
_C.TTTA.SCALE = 1
_C.TTTA.LR_VIDA = 0.0001
_C.TTTA.WD_VIDA = 5e-2
_C.TTTA.HIDDEN_DIM = 128
_C.TTTA.DROPOUT = 0.5
# ------------------------------- Source options -------------------------- #
_C.SOURCE = CfgNode()
