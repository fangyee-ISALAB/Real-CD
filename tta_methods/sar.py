...
class SAR(TTAMethod):
    ...
    def __init__(self, cfg, model, num_classes):
        ...
        self.margin_e0 = cfg.SAR.MARGIN_E0 * math.log(num_classes)  # margin E_0 for reliable entropy minimization, Eqn. (2)
    ...
    def setup_optimizer(self):
        ...
        if "vit_" in architecture_name or "swin_" in architecture_name:
            ...
            return SAM(self.params, torch.optim.Adam, lr=0.001)
        else:
            return SAM(self.params, torch.optim.Adam, lr=self.cfg.OPTIM.LR)
